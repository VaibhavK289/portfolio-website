      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="hidden sm:flex items-center justify-between py-4">
          <div className="flex items-center gap-3">
            ...
            <div><h2 className="font-bold text-gray-900 dark:text-white text-sm">CuraSense</h2><p className="text-xs text-gray-500 dark:text-neutral-500">Technical Deep-Dive</p></div>
          </div>
          <div className="flex items-center gap-1 p-1 bg-gray-100 dark:bg-[#1a2438] rounded-xl">
            ...
            <Link href="/projects/curasense/deep-dive" className="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 bg-white dark:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 shadow-sm">Deep-Dive</Link>
          </div>
        ...
        <div className="sm:hidden">
          <div className="flex items-center justify-between py-2.5">
            <div className="flex items-center gap-2">
              ...
              <div><h2 className="font-bold text-gray-900 dark:text-white text-xs">CuraSense</h2><p className="text-[10px] text-gray-500 dark:text-neutral-500">Deep-Dive</p></div>
            </div>
          ...
          <div className="flex items-center gap-1 pb-2.5 overflow-x-auto scrollbar-hide -mx-3 px-3">
            ...
            <Link href="/projects/curasense/deep-dive" className="flex-shrink-0 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-300 bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 border border-emerald-500/30">Deep-Dive</Link>
          </div>
        </div>
      </div>
    </motion.div>
