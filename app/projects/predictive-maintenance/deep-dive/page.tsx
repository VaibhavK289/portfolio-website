  ...
  if (isLowPerf) {
    return (
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-40 left-10 w-80 h-80 bg-blue-500/15 rounded-full blur-3xl" />
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="hidden sm:flex items-center justify-between py-4">
          <div className="flex items-center gap-3">
            ...
            <div><h2 className="font-bold text-white text-sm">PredictiveCare</h2><p className="text-xs text-neutral-500">Technical Deep-Dive</p></div>
          </div>
          <div className="flex items-center gap-1 p-1 bg-[#1a2438] rounded-xl">
            ...
            <Link href="/projects/predictive-maintenance/docs" className="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 text-neutral-400 hover:text-white">Docs</Link>
            <Link href="/projects/predictive-maintenance/deep-dive" className="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 bg-cyan-500/20 text-cyan-400 shadow-sm">Deep-Dive</Link>
          </div>
          <div className="flex items-center gap-3">
        ...
        <div className="sm:hidden">
          <div className="flex items-center justify-between py-2.5">
            <div className="flex items-center gap-2">
              ...
              <div><h2 className="font-bold text-white text-xs">PredictiveCare</h2><p className="text-[10px] text-neutral-500">Deep-Dive</p></div>
            </div>
          ...
          <div className="flex items-center gap-1 pb-2.5 overflow-x-auto scrollbar-hide -mx-3 px-3">
            ...
            <Link href="/projects/predictive-maintenance/docs" className="flex-shrink-0 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-300 bg-[#1a2438] text-neutral-400">Docs</Link>
            <Link href="/projects/predictive-maintenance/deep-dive" className="flex-shrink-0 px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-300 bg-cyan-500/20 text-cyan-400 border border-cyan-500/30">Deep-Dive</Link>
          </div>
        </div>
      </div>
    </motion.div>
