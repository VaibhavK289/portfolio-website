        ...
        <>
          ...
          >
            ...
            <div className="absolute top-20 left-20 opacity-20">
              <CloudFloat size={120} opacity={0.3} delay={0} />
            </div>
            <div className="absolute bottom-32 right-32 opacity-15">
              <CloudFloat size={90} opacity={0.2} delay={1} />
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className={`fixed z-[9999] bg-gradient-to-br from-[#0a1520] to-[#0c1a28] rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl border border-sky-500/30 ${
              isFullscreen 
                ? 'inset-2 sm:inset-4' 
          ...
          >
            ...
            <div className="hidden sm:block absolute top-0 left-0 w-20 h-20 pointer-events-none">
              <div className="absolute top-2 left-2 w-8 h-0.5 bg-gradient-to-r from-sky-500 to-transparent" />
              <div className="absolute top-2 left-2 w-0.5 h-8 bg-gradient-to-b from-sky-500 to-transparent" />
            </div>
            <div className="hidden sm:block absolute top-0 right-0 w-20 h-20 pointer-events-none">
              <div className="absolute top-2 right-2 w-8 h-0.5 bg-gradient-to-l from-amber-500 to-transparent" />
              <div className="absolute top-2 right-2 w-0.5 h-8 bg-gradient-to-b from-amber-500 to-transparent" />
            </div>

            {/* Window Header - Weather themed */}
            <div className="flex items-center justify-between px-3 sm:px-4 py-2 sm:py-3 bg-gradient-to-r from-[#0c1a28] via-[#111e2e] to-[#0c1a28] border-b border-sky-900/40">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div className="hidden sm:flex items-center gap-2 px-3 py-1 rounded-lg bg-sky-500/10 border border-sky-500/20">
                  <motion.div
                  ...
                  <span className="text-xs text-sky-400 font-medium">Live Weather</span>
                </div>
              </div>
              
              {/* URL Bar */}
              <div className="flex-1 mx-2 sm:mx-4">
                <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-4 py-1.5 sm:py-2 bg-[#08101c]/80 rounded-lg sm:rounded-xl border border-sky-900/40 max-w-lg mx-auto">
              ...
              <div className="flex items-center gap-1 sm:gap-2">
                <button
                  ...
                  className="p-1.5 sm:p-2 text-neutral-400 hover:text-sky-400 transition-colors rounded-lg hover:bg-sky-500/10"
                  aria-label="Refresh"
                >
            ...
            {/* Content Area */}
            <div className="relative w-full h-[calc(100%-44px)] sm:h-[calc(100%-52px)] bg-[#050a14]">
              {/* Loading State */}
              {isLoading && !hasError && (
                <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-[#050a14] via-[#081018] to-[#050a14] z-10">
                  <div className="absolute inset-0 bg-[linear-gradient(rgba(56,189,248,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(56,189,248,0.02)_1px,transparent_1px)] bg-[size:30px_30px]" />
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-[#050a14] via-[#081018] to-[#050a14] z-10">
                  <div className="flex flex-col items-center gap-6 text-center px-8">
                    ...
                    <div className="flex gap-3">
                      <button
                        onClick={handleRefresh}
                        className="px-5 py-2.5 bg-[#1a2438] text-white rounded-xl hover:bg-[#2a3a58] transition-colors text-sm font-medium flex items-center gap-2 border border-sky-900/30"
                      >
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-5 py-2.5 bg-gradient-to-r from-sky-600 to-cyan-600 text-white rounded-xl hover:from-sky-500 hover:to-cyan-500 transition-all text-sm font-medium flex items-center gap-2"
                      >
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        {!imageLoaded && (
          <div className="absolute inset-0 bg-gradient-to-br from-[#050a14] via-[#081018] to-[#050a14]">
            <div className="absolute inset-0 bg-[linear-gradient(rgba(56,189,248,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(56,189,248,0.02)_1px,transparent_1px)] bg-[size:30px_30px]" />
            <div className="absolute inset-0 flex items-center justify-center">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-2 sm:p-4 bg-gradient-to-t from-[#050a14] via-[#050a14]/95 to-transparent">
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 sm:gap-4 flex-wrap">
            <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1 sm:py-1.5 rounded-md sm:rounded-lg bg-sky-500/10 border border-sky-500/30">
              <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-sky-500 animate-pulse" />
              <span className="text-[10px] sm:text-xs text-sky-400 font-medium">Live Data</span>
            </div>
            <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-amber-500/10 border border-amber-500/30">
              <span className="text-xs text-amber-400 font-medium">Rust Backend</span>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-neutral-500">Monitor</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Hover overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-sky-900/0 via-[#050a14]/0 to-amber-900/0 group-hover:from-sky-900/40 group-hover:via-[#050a14]/60 group-hover:to-amber-900/40 transition-all duration-500 flex items-center justify-center active:from-sky-900/40 active:via-[#050a14]/60 active:to-amber-900/40">
        <div className="opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-all duration-300 flex flex-col items-center gap-2 sm:gap-4 px-4">
          {/* Play button */}
          <div className="relative w-14 h-14 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-sky-500/30 to-cyan-500/30 backdrop-blur-md flex items-center justify-center border border-sky-500/50 active:scale-95 sm:hover:scale-110 transition-transform">
          ...
          <div className="text-center">
            ...
            <span className="text-sky-400 text-xs sm:text-sm">Full-Stack Rust Dashboard</span>
          </div>

          <div className="flex items-center gap-1.5 sm:gap-2 mt-1 sm:mt-2 flex-wrap justify-center">
            <span className="px-2 sm:px-3 py-0.5 sm:py-1 text-[10px] sm:text-xs bg-sky-500/20 text-sky-400 rounded-full border border-sky-500/30">
              Rust
            </span>
            <span className="px-2 sm:px-3 py-0.5 sm:py-1 text-[10px] sm:text-xs bg-amber-500/20 text-amber-400 rounded-full border border-amber-500/30">
              Tauri
            </span>
