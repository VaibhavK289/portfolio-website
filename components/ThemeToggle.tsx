...
export function ThemeToggle() {
  ...
  return (
    <motion.button
      ...
      className="relative w-11 h-11 rounded-xl bg-gray-100/80 dark:bg-neutral-900/80 backdrop-blur-sm border border-gray-200/50 dark:border-neutral-800/50 overflow-hidden group"
