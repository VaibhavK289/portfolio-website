      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed z-[9999] bg-gradient-to-br from-[#0a0f1a] to-[#0d1425] rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl border border-cyan-500/30 ${
              isFullscreen 
                ? 'inset-2 sm:inset-4' 
          ...
          >
            ...
            <div className="flex items-center justify-between px-3 sm:px-4 py-2 sm:py-3 bg-gradient-to-r from-[#0c1628] via-[#101d35] to-[#0c1628] border-b border-cyan-900/40">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                {/* Gear indicator - hidden on mobile */}
              ...
              <div className="flex-1 mx-2 sm:mx-4">
                <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-4 py-1.5 sm:py-2 bg-[#0a0f1a]/80 rounded-lg sm:rounded-xl border border-cyan-900/40 max-w-lg mx-auto">
                  <StatusIndicator status={hasError ? 'critical' : 'operational'} size={8} />
              ...
              <div className="flex items-center gap-1 sm:gap-2">
                <button
                  ...
                  className="p-1.5 sm:p-2 text-neutral-400 hover:text-cyan-400 transition-colors rounded-lg hover:bg-cyan-500/10"
                  aria-label="Refresh"
                >
...
export function PredictiveCareScreenshot({ onClick }: { onClick: () => void }) {
  ...
  return (
    ...
    >
      ...
      {/* Corner gear decoration - hidden on mobile for performance */}
      <div className="hidden sm:block absolute -top-4 -left-4 opacity-30 pointer-events-none">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-2 sm:p-4 bg-gradient-to-t from-[#050810] via-[#050810]/95 to-transparent">
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 sm:gap-4 flex-wrap">
            <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1 sm:py-1.5 rounded-md sm:rounded-lg bg-green-500/10 border border-green-500/30">
              <StatusIndicator status="operational" size={6} />
              <span className="text-[10px] sm:text-xs text-green-400 font-medium">Operational</span>
            </div>
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-cyan-900/0 via-[#050810]/0 to-violet-900/0 group-hover:from-cyan-900/40 group-hover:via-[#050810]/60 group-hover:to-violet-900/40 transition-all duration-500 flex items-center justify-center active:from-cyan-900/40 active:via-[#050810]/60 active:to-violet-900/40">
        <div className="opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-all duration-300 flex flex-col items-center gap-2 sm:gap-4 px-4">
          ...
          <div className="relative w-14 h-14 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-cyan-500/30 to-violet-500/30 backdrop-blur-md flex items-center justify-center border border-cyan-500/50 active:scale-95 sm:hover:scale-110 transition-transform">
          ...
          <div className="text-center">
            <span className="text-white font-semibold text-base sm:text-lg block">Explore Dashboard</span>
            <span className="text-cyan-400 text-xs sm:text-sm">Interactive Monitoring</span>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 mt-1 sm:mt-2 flex-wrap justify-center">
            ...
            <span className="hidden xs:inline px-2 sm:px-3 py-0.5 sm:py-1 text-[10px] sm:text-xs bg-green-500/20 text-green-400 rounded-full border border-green-500/30">
              IoT Sensors
            </span>
          </div>
        </div>
